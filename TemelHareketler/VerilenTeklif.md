...
- Sol sekmede Aaro kullanıcı bilgilerinin hemen altında yer alan arama motorundan 'Verilen Teklif' aratarak ulaşım sağlayabilirsiniz.
...
Verilen teklif, bir mal veya hizmetin sağlanması karşılığında belirlenen koşullar, fiyatlar, teslimat süreleri ve diğer önemli bilgileri içeren bir belge veya yazılı açıklamadır. 
Bu tanım, teklifin kapsamını, teslim edilecek ürün veya hizmetlerin detaylarını, ödeme şartlarını ve teklifin geçerlilik süresini belirler.
...
- Yeni Stok Kalemi Ekle: Vereceğimiz teklife stok kalemi eklemek için burayı seçerek ekleme sağlayabilirsiniz.
