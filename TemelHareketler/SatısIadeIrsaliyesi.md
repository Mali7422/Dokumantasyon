---
SayfaID: SatisIadeIrsaliyesi
SayfaTipi: Irsaliye
---

# Satış İade İrsaliyesi

**Erişim Linki :** [erp.aaro.com.tr/FaturaSatisIadeIrsaliyesi](https://erp.aaro.com.tr/FaturaSatisIadeIrsaliyesi)
...
Satış iade irsaliyesi, müşterinin satın aldığı mal veya hizmeti iade etmesi durumunda düzenlenen belgedir. 
Bu irsaliye, iade edilen ürünlerin detaylarını, miktarını ve varsa iade nedenini içerir. 
Ayrıca, iade işleminin muhasebe kayıtlarına doğru bir şekilde yansıtılması için kullanılır. 
Satış iade irsaliyesi, işletmelerin stok ve muhasebe süreçlerini düzenli tutmalarına yardımcı olur.
...
**Teslim Tarihi:** İadenin yapıldığı, yapılacağı tarihi girelim.
...
- Satış iade irsaliyemizde iade edilen stok, gelir gider, demirbaş olabilir. En başta ki kutucuktan seçim yapılabilir, sistem otomatik stok olarak getirir.
...
- Satış iade irsaliyesinde 1 kalem belirtilecekse kaydet diyerek bir sonraki aşamaya geçebiliriz.
...
- Sağ üst köşede faturaya ait toplam fiyat kısımlarını içerir;
	...
	- İskonto Sonrası: Satış iade irsaliyesinin KDV dahil fiyatından uygulanan iskonto tutarını ifade eder.
	- KDV: Satış iade irsaliyesinin KDV oranının karşılık geldiği tutarı ifade eder.
	- Genel Toplam: Satış iade irsaliyesinin tüm kalemlerin KDV dahil tutarının toplamını belirtir.
...
- Görev Oluştur: İade işlemi için görev oluşturup, kişi atayabiliriz, açıklama, tarih bitiş, hatırlatma süresi, yönetici, kullanıcı, tamamlanma tipi, tekrar şekli bilgilerini ekleyerek görev tanımlama işlemimizi gerçekleştirebiliriz.
